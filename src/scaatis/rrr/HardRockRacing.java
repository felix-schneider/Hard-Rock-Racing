...
public class HardRockRacing {
    ...
    private void spawn(Player player) {
        ...
        spawn(player, spawnloc);
    }
    
    private void spawn(Player player, Point2D location) {
        Car car = new Car(location, player.getLastCheckPoint().getOrientation());
        player.setCar(car);
    ...
    private void startRace() {
        ...
        for (int i = 0; i < racers.size(); i++) {
            spawn(racers.get(i), currentTrack.getFinishLine().getStartLocation(i + 1));
        }
